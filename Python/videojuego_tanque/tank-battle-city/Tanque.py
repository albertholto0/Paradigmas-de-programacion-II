...
class Tanque:
    ...
    def __init__(self, screen, tank_config):
        ...
        self.image = pygame.image.load("media/tanque_verde.png")
    ...
    def rotate_image(self):
        """Mét0do para rotar la imagen del tanque según la dirección de movimiento."""
        if self.direction == 'right':
            self.image = pygame.image.load("media/tanque_verde.png")
            self.image = pygame.transform.rotate(self.image, 270)  # Rotar 270° hacia la derecha
        elif self.direction == 'left':
            self.image = pygame.image.load("media/tanque_verde.png")
            self.image = pygame.transform.rotate(self.image, 90)  # Rotar 90° hacia la izquierda
        elif self.direction == 'up':
            self.image = pygame.image.load("media/tanque_verde.png")
            self.image = pygame.transform.rotate(self.image, 0)  # Mantener la imagen en su posición original
        elif self.direction == 'down':
            self.image = pygame.image.load("media/tanque_verde.png")
            self.image = pygame.transform.rotate(self.image, 180)  # Rotar 180° hacia abajo

        self.image_rect = self.image.get_rect(center=self.image_rect.center)

    """ Método que dibuja el tanque en la pantalla en su ubicación actual. """
    def blitme(self):
