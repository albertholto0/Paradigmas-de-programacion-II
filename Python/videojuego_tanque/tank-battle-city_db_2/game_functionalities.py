...
def mostrar_niveles_vida(screen, vida_tanque1, vida_tanque2, tanque1, tanque2):
    ...
    # Mostrar puntuación
    puntuacion_texto_2 = font.render(f"Puntos: {tanque1.puntuacion}", True, (13, 69, 23))  # Puntos del Tanque Verde
    puntuacion_texto_1 = font.render(f"Puntos: {tanque2.puntuacion}", True, (92, 56, 2))  # Puntos del Tanque Arena
    ...
    screen.blit(puntuacion_texto_1, (10, 70))  # Puntos del Tanque Arena
    ...
    screen.blit(puntuacion_texto_2, (screen.get_width() - puntuacion_texto_2.get_width() - 10, 70))  # Puntos del Tanque Verde
