...
public class Ejercicio3_piedra_papel_tijeras extends javax.swing.JFrame {
    ...
    public Ejercicio3_piedra_papel_tijeras() {
        initComponents();
        try {
            historialFile = new FileWriter("src\\historial.txt", true); // Abre el archivo en modo de añadir (append)
        } catch (Exception e) {
    ...
    private void confirmarOpMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_confirmarOpMouseClicked
        try{
    ...
    }//GEN-LAST:event_confirmarOpMouseClicked
